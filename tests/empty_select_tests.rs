...
// [spec:pgorm:sem:query.build.modifiers+8/test]    every execution path over a
...
// [spec:pgorm:sem:query.build.modifiers+8/test]    a hand-rolled statement,
...
// [spec:pgorm:sem:query.build.modifiers+8/test]    a statement whose projection
