...
// [spec:pgorm:def:sql.render.value-literals+4/test]    against a live server: an
...
// [spec:pgorm:req:sql.render.select-order+4/test]    a named window combined with ORDER BY and
