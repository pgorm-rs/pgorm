...
// [spec:pgorm:sem:entity.traits.column.enum-cast+2/test]    on read, `select_as` /
...
// [spec:pgorm:sem:entity.traits.column.enum-cast+2/test]    the special case:
...
// [spec:pgorm:sem:entity.traits.column.enum-cast+2/test]    the casts survive a
