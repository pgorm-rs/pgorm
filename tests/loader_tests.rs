...
// [spec:pgorm:sem:query.loader.batching+7/test]    keys are collected in input
...
// [spec:pgorm:sem:query.loader.batching+7/test]    a relation naming a column
...
// [spec:pgorm:sem:query.loader.batching+7/test]    the relation reaches SQL
...
// [spec:pgorm:sem:query.loader.batching+7/test]    a self-referencing `HasOne`
