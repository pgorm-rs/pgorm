    ...
    fn impl_active_enum(&self) -> TokenStream {
        ...
        let impl_enum_variant_iden = if !str_variants.is_empty() {
            ...
            quote!(
                ...
                impl pgorm::pgorm_query::Iden for #enum_variant_iden {
                ...
                impl #ident {
                    #[doc = " Generated by pgorm-macros"]
                    pub fn iden_values() -> Vec<pgorm::pgorm_query::DynIden> {
                        <#enum_variant_iden as pgorm::strum::IntoEnumIterator>::iter()
                            .map(|v| pgorm::pgorm_query::SharedIden::new(v) as pgorm::pgorm_query::DynIden)
                            .collect()
                    }
                }
            )
        ...
        quote!(
            ...
            #[automatically_derived]
            impl pgorm::pgorm_query::Iden for #enum_name_iden {
                fn unquoted(&self, s: &mut dyn std::fmt::Write) {
            ...
            impl pgorm::ActiveEnum for #ident {
                ...
                fn name() -> pgorm::pgorm_query::DynIden {
                    pgorm::pgorm_query::SharedIden::new(#enum_name_iden) as pgorm::pgorm_query::DynIden
                }
