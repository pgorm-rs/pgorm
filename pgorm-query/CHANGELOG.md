...
+ `pgorm-query`/`0.32.0-rc.1`: 2024-08-09
+ `pgorm-query-binder`/`0.7.0-rc.1`: 2024-08-09
+ `pgorm-query-rusqlite`/`0.7.0-rc.1`: 2024-08-09
+ `pgorm-query-postgres`/`0.5.0-rc.1`: 2024-08-09
...
+ `pgorm-query`/`0.31.0-rc.1`: 2024-01-31
+ `pgorm-query`/`0.31.0-rc.4`: 2024-02-02
+ `pgorm-query`/`0.31.0-rc.5`: 2024-04-14
+ `pgorm-query`/`0.31.0-rc.6`: 2024-05-03
+ `pgorm-query`/`0.31.0-rc.7`: 2024-06-02
+ `pgorm-query`/`0.31.0-rc.8`: 2024-06-19
+ `pgorm-query-binder`/`0.6.0-rc.1`: 2024-01-31
+ `pgorm-query-binder`/`0.6.0-rc.2`: 2024-04-14
+ `pgorm-query-binder`/`0.6.0-rc.3`: 2024-06-19
+ `pgorm-query-binder`/`0.6.0-rc.4`: 2024-06-25
+ `pgorm-query-binder`/`0.6.0`: 2024-08-02
+ `pgorm-query-rusqlite`/`0.6.0-rc.1`: 2024-02-19
+ `pgorm-query-rusqlite`/`0.6.0`: 2024-08-02
+ `pgorm-query-attr`/`0.1.2`: 2024-04-14
+ `pgorm-query-diesel`/`0.2.0`: 2024-08-02
...
* MySQL blob types moved to `pgorm_query::extension::mysql::MySqlType`; `ColumnDef::blob()` now takes no parameters
```rust
assert_eq!(
    Table::create()
...
## `pgorm-query-rusqlite` 0.5.0 - 2023-12-29
...
### `pgorm-query-derive` 0.4.1 - 2023-10-19

* Upgrade `syn` to `2`

## 0.30.2 - 2023-09-23

+ [`pgorm-query-diesel`/`0.1.0`](https://crates.io/crates/pgorm-query-diesel/0.1.0)
...
+ [`pgorm-query-postgres`/`0.4.0`](https://crates.io/crates/pgorm-query-postgres/0.4.0)
+ [`pgorm-query-rusqlite`/`0.4.0`](https://crates.io/crates/pgorm-query-rusqlite/0.4.0)
+ [`pgorm-query-rbatis`/`0.1.0`](https://crates.io/crates/pgorm-query-rbatis/0.1.0)
...
+ [`pgorm-query-binder`/`0.5.0`](https://crates.io/crates/pgorm-query-binder/0.5.0)

### Notes

`pgorm-query 0.29` has a number of breaking changes, so it might be easier for you to first upgrade to `0.29`, then upgrade `sqlx` by bumping to `0.30`.

## 0.29.1 - 2023-07-12

### Versions

+ `pgorm-query`/`0.29.0-rc.1`: 2023-03-22
+ `pgorm-query`/`0.29.0` (Yanked)
+ `pgorm-query`/`0.29.1`: 2023-07-12
+ [`pgorm-query-binder`/`0.4.0`](https://crates.io/crates/pgorm-query-binder/0.4.0)
+ [`pgorm-query-postgres`/`0.3.0`](https://crates.io/crates/pgorm-query-postgres/0.3.0)
+ [`pgorm-query-rusqlite`/`0.3.0`](https://crates.io/crates/pgorm-query-rusqlite/0.3.0)
...
* Added implementation `SqlxBinder`, `RusqliteBinder` and `PostgresBinder` for `WithQuery` https://github.com/SeaQL/sea-query/pull/580
    * `pgorm-query-binder` `0.3.1`
    * `pgorm-query-postgres` `0.2.1`
    * `pgorm-query-rusqlite` `0.2.1`
...
* Added convert various `UUID` defined in `uuid::fmt` module into `pgorm_query::Value::Uuid` https://github.com/SeaQL/sea-query/pull/563
...
* Support `BigDecimal`, `IpNetwork` and `MacAddress` for `pgorm-query-postgres` https://github.com/SeaQL/sea-query/pull/503
...
// given
let (statement, values) = pgorm_query::Query::select()
    .column(Glyph::Id)
    .from(Glyph::Table)
    .cond_where(Cond::any()
    ...
    .build(pgorm_query::MysqlQueryBuilder);
...
(https://github.com/SeaQL/sea-query/pull/416, https://github.com/SeaQL/sea-query/pull/423):
	1. `pgorm-query-binder` is now the recommended way (trait based) of working with SQLx, replacing `pgorm-query-driver` (macro based) https://github.com/SeaQL/sea-query/pull/434
	2. `pgorm-query-binder` is now a separate dependency, instead of integrated with `pgorm-query` https://github.com/SeaQL/sea-query/pull/432
	3. `rusqlite` support is moved to `pgorm-query-rusqlite` https://github.com/SeaQL/sea-query/pull/422
	4. `postgres` support is moved to `pgorm-query-postgres` https://github.com/SeaQL/sea-query/pull/433
...
* Introduce `pgorm-query-binder` https://github.com/SeaQL/sea-query/pull/275
...
* [pgorm-query-attr] macro for deriving `Iden` enum from struct https://github.com/SeaQL/sea-query/pull/300
...
* Make `pgorm-query-driver` an optional dependency https://github.com/SeaQL/sea-query/pull/324
...
* As part of #283, the drivers are split to the `pgorm-query-driver` crate
...
+ Update pgorm-query-derive to 0.1.2
