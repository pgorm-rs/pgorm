...
// [spec:pgorm:req:sql.ddl.column-def+6/test]    only the integer trio has a serial spelling
#[test]
...
// [spec:pgorm:req:sql.ddl.column-def+6/test]    a type with no serial form renders itself
#[test]
