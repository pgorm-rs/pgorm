    ...
    fn impl_active_enum(&self) -> TokenStream {
        ...
        let impl_try_getable_array = if cfg!(feature = "postgres-array") {
            quote!(
                ...
                impl sea_orm::TryGetableArray for #ident {
                    fn try_get_by<I: sea_orm::RowIndex + std::fmt::Display>(res: &sea_orm::QueryResult, index: I) -> std::result::Result<Vec<Self>, sea_orm::TryGetError> {
        ...
        quote!(
            ...
            impl sea_orm::TryGetable for #ident {
                fn try_get_by<I: sea_orm::RowIndex + std::fmt::Display>(res: &sea_orm::QueryResult, idx: I) -> std::result::Result<Self, sea_orm::TryGetError> {
