...
// [spec:pgorm:sem:codegen.ddl.objects+3/test]    a CREATE TYPE ... AS ENUM
...
// [spec:pgorm:sem:codegen.ddl.objects+3/test]    a single-column unique index
...
// [spec:pgorm:sem:codegen.ddl.objects+3/test]    COMMENT ON statements are folded
...
// [spec:pgorm:sem:codegen.ddl.objects+3/test]    the round trip holds for the
