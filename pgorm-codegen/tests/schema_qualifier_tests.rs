...
// [spec:pgorm:sem:codegen.ddl.objects+4/test]    an index attaches to the table
...
// [spec:pgorm:sem:codegen.ddl.objects+4/test]    and a qualified index that does
...
// [spec:pgorm:sem:codegen.ddl.objects+4/test]    a comment resolves the same way
#[test]
...
// [spec:pgorm:sem:codegen.ddl.objects+4/test]    an unqualified reference that
